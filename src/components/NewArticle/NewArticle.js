...
const NewArticle = () => {
  ...
  const handleSubmitCreate = (event) => {
    ...
    let a = `${provinces.find((pr) => pr.code === address.provinceCode).name} ${
  ...
  return (
    <div
      className="container"
      style={{ backgroundColor: "#fff", borderRadius: 10, padding: 40 }}
    >
      {profile.details != null ? (
        <form onSubmit={handleSubmitCreate}>
          ...
          <FormControl fullWidth margin="normal">
            <FormLabel>Tinh, Thành Phố <i>({article_id ? formData.address : ""})</i></FormLabel>
            <Select
              name="provinceCode"
          ...
          <FormControl fullWidth>
            ...
            <FileBase
              ...
              multiple={false}
              onDone={({ base64 }) =>
                setFormData({ ...formData, image_tu_cua: base64 })
              }
            />
          </FormControl>
          <br />
          <FormControl fullWidth>
            ...
            <FileBase
              ...
              multiple={false}
              onDone={({ base64 }) =>
                setFormData({ ...formData, image_wc: base64 })
              }
            />
          </FormControl>
          <br />
