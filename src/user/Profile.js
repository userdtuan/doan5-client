                ...
                <div className="row col-12">
                    ...
                    <div className="col-3">
                        <div style={{marginLeft: 20}}>
                            <div className="row" style={{alignItems: 'center', paddingTop: 10}}>
                            ...
                            <div className="row" style={{justifyContent: 'center', paddingTop: 20}}>
                                <Button style={{backgroundColor: '#FED082', border: "1px solid #FED082",  alignItems: 'center'}}>Chỉnh sửa thông tin</Button>
                            </div>
                        </div>
                    </div>
                </div>
