...
const Profile = () => {
  ...
  useEffect(() => {
    if (profile.details?.user_id) {
      Axios.get(
        `http://localhost:5000/articles/get-by-id/${profile.details.user_id}`,
        {
          headers: {
            "Content-Type": "application/json",
          },
              ...
              <div>
                {articles.map((article, index) => (
                  ...
                  <Grid container>
                    ...
                    >
                      <img src={iconEdit} className={classes.iconLove} onClick={()=>history.push(`/edit/${article._id}`)}   ></img>
                      <img src={iconShow} className={classes.iconLove} onClick={()=>handleStatusChange(article._id,false)}></img>
                      <img src={iconDel} className={classes.iconLove} onClick={()=>handleDelete(article._id)}></img>
                    </Grid>
                  </Grid>
                </Card>
                <br />
              ...
              <div>
                {articles.map((article, index) => (
                  ...
                  <Grid container>
                    ...
                    >
                      <img src={iconEdit} className={classes.iconLove} onClick={()=>history.push(`/edit/${article._id}`)}   ></img>
                      <img src={iconShow} className={classes.iconLove} onClick={()=>handleStatusChange(article._id,true)}   ></img>
                      <img src={iconDel} className={classes.iconLove} onClick={()=>handleDelete(article._id)}></img>
                    </Grid>
                  </Grid>
                </Card>
